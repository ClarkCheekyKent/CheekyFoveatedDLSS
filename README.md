...
4. UEVR AFW supports DX12 SR and NR with fixed or gaze-driven coverage using the public AFW UEVR build. Start with Automatic under Stereo and gaze; status details are under Diagnostics and support. See the [AFW setup and compatibility notes](uevr/README.md#afw).
